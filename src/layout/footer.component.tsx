                ...
                <div className="flex justify-between items-center flex-col sm:flex-row">
                    <div className="mb-6 md:mb-0">
                        ...
                        <div className="flex mt-5 sm:justify-center">
                            ...
                            <a href="#" className="text-[--primary-v3] hover:text-[--primary-v6] dark:hover:text-[--primary-v1] ms-5">
                    ...
                    <div className='flex gap-4 items-center mx-4 flex-col sm:flex-row'>
                        ...
                        <a href="#"
                            className="no-underline bg-blue-600 text-white px-[5rem] py-2 rounded-3xl hover:bg-blue-500" >
                            Start OTC
                        </a>
                        <a href="#"
